"""
Django settings for voya_weather project.
...
SECRET_KEY = 'django-insecure--y^zb(my!)(rhk*=+v3584s_ncxh-@633xm3mx)7^y8g!+p*4d'
...
ROOT_URLCONF = 'voya_weather.urls'
...
WSGI_APPLICATION = 'voya_weather.wsgi.application'
